...
Trois choses ont changé depuis ta dernière partie, toutes de notre côté, pas du jeu :
...
- **Un humain regarde jouer et peut te parler.** Ses messages arrivent en tête de ta
  prochaine réponse d'outil, sous `LE JOUEUR TE PARLE`. Ils n'arrivent qu'une fois.

Ce dernier point mérite mieux qu'une obéissance ponctuelle : quand il te corrige, demande-
...
pour toujours. En vingt-deux parties tu n'as jamais rien écrit — c'était probablement notre
faute, on t'a toujours interrompu en pleine action.
